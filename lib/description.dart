                          ...
                          IconButton(onPressed: (){}, icon: Icon(Icons.heart_broken_outlined)),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  Image.network(p.image ,height:MediaQuery.of(context).size.height*0.3,width:MediaQuery.of(context).size.width*0.3,fit:BoxFit.contain,),
                                ],),
                        )
                            ),
                    ),
                ...
                children: [
                  SizedBox(height: MediaQuery.of(context).size.height*0.01,),
                   ...
                   SizedBox(height:MediaQuery.of(context).size.height*0.06 ),
                            ...
                            children: [
                        Container(color: Colors.white,width:MediaQuery.of(context).size.width/2-20, height:MediaQuery.of(context).size.height*0.05,
                          child:FittedBox(child:MaterialButton(onPressed: (){},child: Row(children: [Text("Add To Favoriet",),SizedBox(width:20,),
                          Icon(  Icons.favorite,size:25,color: Colors.red,)],),)),),
                      
            
                       Container(color: Colors.white,width: MediaQuery.of(context).size.width/2-20,height:MediaQuery.of(context).size.height*0.05,
                          child:FittedBox(child:  MaterialButton(onPressed: (){},child: Row(children: [Text("Add To Card"),SizedBox(width:30,),
